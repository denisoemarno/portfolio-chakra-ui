...
import { DiDocker, DiCode, DiJavascript1 } from 'react-icons/di'
...
function Profile() {
    ...
    return (
        <Flex direction={isNotSmallerScreen ? "row" : "column"} w="100%"
            ...
            <Box alignSelf="center" px="32" py="16">
                <Text fontWeight="bold" fontSize="2xl">IT Manage Service and Devops Engineer, specialised CI-CD deployment.</Text>
                <Flex direction={isNotSmallerScreen ? "row" : "column"} mt={8} >
                    ...
                    >
                        <Icon as={DiJavascript1} p="4" w="24" h="24" color="black" />
                        <Text color="black" p="4" fontSize="xl" fontWeight="semibold">
                            Javascript
                        </Text>
                    </Flex>
